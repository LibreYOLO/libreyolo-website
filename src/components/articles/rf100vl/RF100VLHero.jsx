  ...
  return (
    <div className="rfa-layer" aria-label="The seven RF100-VL domains as themed rings">
      ...
      <div className="rfa-core">
        <span className="rfa-core-pill">RF-DETR</span>
        <div className="rfa-core-sub">benchmarked on 100 real-world datasets</div>
...
export default function RF100VLHero({ title, author, dateISO, dateLabel, backLink }) {
  // Two stages: 'art' shows the seven themed domain rings around RF-DETR;
        ...
        {exploring && (
          <div className="rfe-layer">
            ...
            <div className="rfp-core" aria-hidden="true">
              <span className="rfp-core-pill">RF-DETR</span>
              <div className="rfp-core-sub">1 model · 100 datasets</div>
            </div>
