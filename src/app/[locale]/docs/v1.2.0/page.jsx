          ...
          <div className="mb-8 rounded-lg border border-surface-200 dark:border-white/[0.08] bg-white/80 dark:bg-white/[0.03] p-4 shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-surface-600 dark:text-surface-400">
                    {isLatest
                    ? `These are the docs for v1.2.0, an earlier release. The latest stable docs are v${DOCS_CURRENT_VERSION}, at /docs.`
...
print(result.saved_path)`}</CodeBlock>
          ...
          <P>
            These docs cover v1.2.0, the previous release. For the newest features, see the v1.3.0 docs.
          </P>
          ...
          <div className="mb-8 rounded-lg border border-surface-200 dark:border-white/[0.08] bg-white/80 dark:bg-white/[0.03] p-4 shadow-sm">
            <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
                <p className="text-sm text-surface-600 dark:text-surface-400">
                    {isLatest
                    ? `这是早期版本 v1.2.0 的文档。最新稳定文档为 v${DOCS_CURRENT_VERSION}，位于 /docs。`
