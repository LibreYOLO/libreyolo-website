...
const metadataByLocale = {
  en: {
    title: 'Docs v1.2.0 (earlier release)',
    description: 'Documentation for LibreYOLO v1.2.0, an earlier release: flagship YOLO9 and RF-DETR detection, training, validation, tiled inference, and ONNX / TensorRT / OpenVINO / NCNN export.',
  },
  zh: {
    title: 'v1.2.0 文档（早期版本）',
    description: 'LibreYOLO v1.2.0 早期版本文档：旗舰 YOLO9 与 RF-DETR 检测、训练、验证、分块推理，以及 ONNX、TensorRT、OpenVINO 和 NCNN 导出。',
  },
}
