...
# model = LibreYOLO("LibreRFDETRn-obb.pt")     # obb   (experimental)`}</CodeBlock>
          ...
          <DocTable
            ...
            rows={[
              ...
              ['ResNet', <SupportBadge key="b">Experimental</SupportBadge>, 'classify', <Checkpoints key="rn" link={false} names={['LibreResNet18-cls.pt', 'LibreResNet34-cls.pt', 'LibreResNet50-cls.pt', 'LibreResNet101-cls.pt']} />],
              ['CLIP', <SupportBadge key="b">Experimental</SupportBadge>, 'classify (zero-shot)', <Checkpoints key="clip" link={false} names={['LibreCLIPb32-cls.pt', 'LibreCLIPb16-cls.pt']} />],
...
print(result.boxes.xyxy)`}</CodeBlock>
          ...
          <DocTable
            ...
            rows={[
              ...
              [<InlineCode key="pf">profile</InlineCode>, 'Profile a training run (model.train(profile=True)): bottlenecks, kernels, and ops'],
...
# model = LibreYOLO("LibreRFDETRn-obb.pt")     # obb   (experimental)`}</CodeBlock>
          ...
          <DocTable
            ...
            rows={[
              ...
              ['ResNet', <SupportBadge key="b">实验性</SupportBadge>, 'classify', <Checkpoints key="rn" link={false} names={['LibreResNet18-cls.pt', 'LibreResNet34-cls.pt', 'LibreResNet50-cls.pt', 'LibreResNet101-cls.pt']} />],
              ['CLIP', <SupportBadge key="b">实验性</SupportBadge>, 'classify (zero-shot)', <Checkpoints key="clip" link={false} names={['LibreCLIPb32-cls.pt', 'LibreCLIPb16-cls.pt']} />],
...
print(result.boxes.xyxy)`}</CodeBlock>
          ...
          <DocTable
            ...
            rows={[
              ...
              [<InlineCode key="pf">profile</InlineCode>, '分析训练性能剖析（model.train(profile=True)）：定位瓶颈、内核与算子'],
