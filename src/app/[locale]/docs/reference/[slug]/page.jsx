...
// Reference pages document the deliberate public surface and the schemas. Curated prose plus tables, never an autodumped API listing.
const SECTION = 'reference'
const SECTION_LABEL = 'Reference'
