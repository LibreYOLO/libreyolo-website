...
Mosaic вибирає до 20 кандидатів, надаючи перевагу зображенням із розміткою; якщо жодне не підходить, залишається останній вибір.
...
[TFLite INT8](/docs/export/tflite) приймає `int8=True` і калібрувальний датасет.
