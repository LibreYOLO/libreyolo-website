...
Передбачення виявлення приймає прямокутний `imgsz=(height, width)`; навчання й експорт зберігають власні обмеження форми.
...
Варіанти `obj2coco` охоплюють виявлення, сегментацію та позу. Для їх завантаження потрібна явна згода, а вихідні умови обмежують комерційне використання. Оригінальні контрольні точки COCO зберігають записаний дозвіл Apache-2.0.
