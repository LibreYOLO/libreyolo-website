...
families:
  - moge2
seo_title: 'MoGe-2 у Python: нормалі поверхні з одного зображення, MIT'
description: >-
...
Ваги завантажуються автоматично під час першого використання. Розміри s і l використовують дзеркала LibreYOLO; b і далі використовує вихідну контрольну точку.
...
Контрольні точки s і l розміщено на дзеркалах LibreYOLO; b залишається у вихідному репозиторії. Завантажені артефакти зберігають ліцензію видавця.
