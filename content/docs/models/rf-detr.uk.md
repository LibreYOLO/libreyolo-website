...
Виявлення, сегментація та орієнтовані рамки використовують білінійне масштабування OpenCV з рухомою комою без згладжування; для пози збережено масштабування зі згладжуванням. Прямокутний `imgsz=(height, width)` має відповідати сітці патчів і вікон завдання. Перелік контрольних точок містить детектор інтерфейсу. [Гістограми подій](/docs/train/event-histograms) використовують записаний профіль вхідних даних.
