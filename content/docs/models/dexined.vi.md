...
families:
  - dexined
seo_title: 'DexiNed: phát hiện cạnh, dùng checkpoint của bạn'
description: >-
  Dùng DexiNed trong LibreYOLO để dự đoán xác suất cạnh dense. Chuyển đổi
  checkpoint mà bạn được cấp phép sử dụng, sau đó dự đoán, xác thực và xuất.
lead: >-
  DexiNed (Dense Extreme Inception Network) là mạng tích chập dự đoán map xác
