...
Три размера: 450m, 1.6b и 3b, все из релиза LFM2.5-VL от Liquid AI. `lfm2-vl-3b` выбирает модель LFM2.5 3B и её парсер рамок 0–1000. Бенчмарки LibreYOLO не измеряли это семейство, поэтому опубликованных показателей точности для сравнения нет; выбирайте размер по своему вычислительному бюджету.
