...
странице [Гиперпараметры](/docs/train/hyperparameters).
...
Не совмещайте эти два способа. Если окружение torchrun присутствует, `device="0,1"`
...
Автоматическое порождение процессов поддерживают не все семейства. Таких
двадцать четыре — все обучаемые семейства детекции, классификации, семантической
сегментации и восстановления. Семейство без такой поддержки,
