...
description: "The LibreVLM factory, every model alias, the sticky set_classes vocabulary, set_task, the chat escape hatch, and why confidence is a placeholder."
lead: "LibreVLM loads a generative vision-language model and drives it as an object detector. The class list is a prompt rather than a fixed head, and the model returns the same Results any other family returns."
keywords:
  - LibreVLM
