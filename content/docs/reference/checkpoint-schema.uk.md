...
Власний вибір записує `fitness_source="callback"` і `fitness/custom`. Код і стан колбеку не зберігаються; ці запуски не можна відновити. Починайте новий запуск із їхніх ваг.
