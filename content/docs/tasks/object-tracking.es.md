...
`classes`, `max_det`, `vid_stride`, `show`, y `save` con `output_path`. La fuente puede ser un vídeo o una secuencia ordenada de imágenes. Consulta [predicción](/docs/predict) para el
