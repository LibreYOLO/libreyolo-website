...
Сімейства з підтримкою навчання:
...
Семантичні датасети приймають полотна `(height, width)`. PP-LiteSeg і U-Net розрізняють навчальні обрізання й прямокутники оцінювання. Вибірка з масштабуванням та обрізанням заповнює відсутні ділянки міткою ігнорування; фотометричні перетворення сімейства застосовуються там, де їх налаштовано.
