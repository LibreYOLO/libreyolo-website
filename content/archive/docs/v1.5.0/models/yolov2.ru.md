...
lead: >-
  ...
  который добавил в линейку YOLO якорные рамки и passthrough-слой. LibreYOLO
...
YOLOv2 не требует ничего сверх базового пакета.
...
уверенности, а `iou` — по порогу NMS; оба применяются к якорным предсказаниям
головы `region`.
