...
families:
  - kosmos2
seo_title: 'LibreYOLO의 Kosmos-2: 그라운딩 객체 탐지'
description: >-
  LibreYOLO에서 Kosmos-2를 설치하고 오픈 보캐뷸러리를 설정하여 Microsoft의 MIT 라이선스 모델로 그라운딩된 바운딩
  박스를 예측합니다.
lead: >-
  Kosmos-2는 이미지에 캡션을 생성한 다음 해당 캡션의 각 명사구를 바운딩 박스로 찾는 Microsoft의 그라운딩 모델입니다.
...
또는 전체 제외로 동작하며 여기서 `iou`는 효과가 없습니다. 래퍼가 중복 제거 단계
