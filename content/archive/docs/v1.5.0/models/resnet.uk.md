...
families:
  - resnet
seo_title: 'ResNet: навчання, валідація та експорт під ліцензією Apache-2.0'
description: >-
  Використовуйте ResNet у LibreYOLO для класифікації зображень. Установлюйте,
  виконуйте передбачення, донавчання, валідацію та експорт
  LibreResNet18/34/50/101.
lead: >-
  ResNet є класифікатором зображень на основі залишкових блоків і пропускних
  з'єднань, які дають мережі змогу додавати значно більше шарів без втрати
  правильності, якої інакше зазнають глибокі звичайні згорткові стеки. LibreYOLO
...
ResNet не потребує додаткових залежностей. Усе, що вона імпортує, входить до
...
Доступні чотири глибини, усі з однаковим процесом навчання та оцінювання, тому
вибір прямо зіставляє кількість параметрів із правильністю. Завдання
фіксоване: кожен розмір охоплює лише класифікацію. Назва файлу ваг кожного
розміру завершується на `-cls.pt`, і за цим суфіксом фабрика маршрутизує до
...
шарами `nn.Linear`, яких немає в ResNet.
