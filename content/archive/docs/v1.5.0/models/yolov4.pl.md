...
families:
  - yolo4
seo_title: 'YOLOv4: uruchamianie, walidacja i eksport w LibreYOLO'
description: >-
  Uruchamiaj YOLOv4 w LibreYOLO: zamrożoną, muzealną rodzinę wyłącznie do
  inferencji z backbone CSPDarknet-53. Przewiduj, waliduj i eksportuj na
  licencji domeny publicznej.
lead: >-
  YOLOv4 łączy backbone CSPDarknet-53, blok SPP i neck PANet z aktywacjami Mish.
  LibreYOLO udostępnia go jako zamrożony eksponat przeznaczony wyłącznie do
  inferencji, w rozmiarach tiny i base.
keywords:
  - YOLOv4
  - Darknet
  - CSPDarknet-53
...
a `iou` próg NMS, stosowane po własnym skalowaniu środka `scale_x_y` każdej
głowicy. Więcej informacji o źródłach, streamingu i obsłudze wyników zawiera
