...
description: "Run a LibreYOLO training job on a rented or serverless GPU: stage the data, install, launch, watch it live, retrieve the weights and stop paying."
lead: "A rented GPU turns a training run into a job with a start, an end, and a bill. The work is the same as training locally; what changes is getting the data in, watching from outside, getting the weights out, and shutting the machine down."
keywords:
  - cloud gpu training
  - rent a gpu
  - vast.ai training
