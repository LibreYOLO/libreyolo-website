...
lead: >-
  ...
  com o onnx2tf em modo flatbuffer-direct e escreve os metadados do modelo ao
  lado do artefato como um sidecar JSON.
keywords:
  ...
  run:
    ...
    - label: LiteRT puro
      ...
      code: >
        ...
        # O pré-processamento, a transposição de NCHW para NHWC e o
        pós-processamento são seus.
  support:
