...
description: >-
  Запуск SSD300 в LibreYOLO: одностадийный детектор на VGG16 для предсказания,
...
В SSD один чекпойнт: сеть SSD300 на базе VGG16 с фиксированным родным холстом.
Выбора размера или масштаба в этом семействе нет; предсказание, валидация и
экспорт используют один и тот же граф.
